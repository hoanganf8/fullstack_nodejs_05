...
root.innerHTML = (0, _app.App)();

},{"./src/App":"2kQhy"}],"2kQhy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "App", ()=>App);
var _moment = require("moment"); //Import từ node_modules
var _momentDefault = parcelHelpers.interopDefault(_moment);
var _styleScss = require("./assets/style.scss");
var _header = require("./components/Header");
var _footer = require("./components/Footer");
var _jsx01Png = require("./assets/img/jsx-01.png");
var _jsx01PngDefault = parcelHelpers.interopDefault(_jsx01Png);
var _configJson = require("./config.json");
var _configJsonDefault = parcelHelpers.interopDefault(_configJson);
const { SERVER_API, WEB_TITLE } = (0, _configJsonDefault.default);
const App = ()=>{
    return `
    ${(0, _header.Header)()}
    <h2>H\u{1ECD}c l\u{1EAD}p tr\xecnh kh\xf4ng kh\xf3</h2>
    <div><img src="${0, _jsx01PngDefault.default}" style="width: 200px"/></div>
    <p>Server API: ${SERVER_API}</p>
    <p>Web Title: ${WEB_TITLE}</p>
    <h3>${(0, _momentDefault.default)().format()}</h3>
    ${(0, _footer.Footer)()}
  `;
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./components/Header":"hsJbF","./components/Footer":"8pPOA","./assets/style.scss":"ll5JQ","./assets/img/jsx-01.png":"jdCQW","./config.json":"8VeYg","moment":"jwcsj"}],"gkKU3":[function(require,module,exports) {
...
const Header = ()=>{
    ...
    console.log("F8 Academy1");
    console.log("contact@fullstack.edu.vn");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ll5JQ":[function() {},{}],"jdCQW":[function(require,module,exports) {
module.exports = require("9243cecddf7cdc50").getBundleURL("3gKDs") + "jsx-01.7d53976a.png" + "?" + Date.now();

},{"9243cecddf7cdc50":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
module.exports = JSON.parse('{"SERVER_API":"http://api-gateway.fullstack.edu.vn","WEB_TITLE":"F8 - Fullstack"}');
...
},{}]},["6DoTH","adjPd"], "adjPd", "parcelRequire0194")

...
/*
Trong Funcional Component chỉ có 2 tác dụng
- Hiển thị giao diện (JSX)
- Truyền Props

Hook ==> Thao tác với các chức năng khác của React JS, để functional component có các chức năng giống như class component
